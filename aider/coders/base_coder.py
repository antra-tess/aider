...
class Coder:
        ...
        **kwargs,
        ...
        if from_coder:
            ...
            update = dict(
                ...
                continuous_watcher=from_coder.continuous_watcher,
            )
    ...
    def __init__(
        ...
        self.continuous_watcher = continuous_watcher
        if self.continuous_watcher:
            self.continuous_watcher.coder = self
